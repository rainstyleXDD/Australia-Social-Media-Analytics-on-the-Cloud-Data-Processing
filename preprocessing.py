...
def main():
    ...
    LGA_CODE_2021 = {}
    LGA_CODE_2022 = {}
    with open('CG_LGA_2021_LGA_2022.csv', mode ='r')as f:
        LGA = csv.DictReader(f)
        for lga in LGA:
            LGA_CODE_2021[lga['LGA_CODE_2021']] = lga['LGA_NAME_2021']
            LGA_CODE_2022[lga['LGA_CODE_2022']] = lga['LGA_NAME_2022']
